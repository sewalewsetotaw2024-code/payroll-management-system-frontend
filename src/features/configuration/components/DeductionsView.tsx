...
export const DeductionsView: React.FC<DeductionsViewProps> = ({
  ...
  <div className="space-y-6">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/50">
              <th className="text-left px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Name</th>
              <th className="text-left px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Category</th>
              <th className="text-left px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Value</th>
              <th className="text-left px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Tags</th>
          ...
          <tbody className="divide-y divide-slate-50">
            {paginatedDeductions.map((deduction, i) => {
              ...
              return (
                <tr key={`ded-${(displayPage - 1) * pageSize + i}`} className="hover:bg-slate-50/30 transition-all group">
    ...
    {/* Info Card */}
    <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/30 border border-emerald-200 rounded-[1.5rem] p-6 shadow-sm">
      <div className="flex items-start gap-4">
        <div className="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0 border border-emerald-200/50">
